...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"mcie":[function(require,module,exports) {
"use strict";
...
function getCountryStats(countryOrRegion) {
  return __awaiter(this, void 0, void 0, function () {
    var primaryKey, apiEnpoint;
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          primaryKey = "b8e75c953eaf408a80eb20222bd330b3";
          apiEnpoint = "https://api.smartable.ai/coronavirus/stats/" + countryOrRegion;
          return [4
          /*yield*/
          , fetch(apiEnpoint, {
            headers: {
...
},{}],"Zplo":[function(require,module,exports) {
"use strict";
...
function matchRegionsHist(regions, nCases, attribute) {
  var res = {};
  Object.keys(regions).forEach(function (key) {
    var regionHist = regions[key];
    var regionMatchedHist = matchRegionHist(regionHist, nCases, attribute);
    res[key] = regionMatchedHist;
  });
  return res;
}

exports.matchRegionsHist = matchRegionsHist;

function matchRegionHist(hist, nCases, attribute) {
  return hist.filter(function (h) {
    return h[attribute] >= nCases;
  }).map(function (h, i) {
    h.index = i;
    return h;
  });
...
exports.matchRegionHist = matchRegionHist;
},{}],"zSG3":[function(require,module,exports) {
module.exports = [{
  "code": "AD",
  "emoji": "🇦🇩",
...
},{}],"bQ0p":[function(require,module,exports) {
"use strict";
...
var countryFlags_json_1 = __importDefault(require("./countryFlags.json"));

function renderCountriesSelection(_a) {
  var _b = _a.initialValue,
      initialValue = _b === void 0 ? [] : _b;
  console.log("Render countries", countryFlags_json_1.default.length);
...
exports.renderCountriesSelection = renderCountriesSelection;

function getCoutryEmoji(countryCode) {
  var _a;

  return (_a = countryFlags_json_1.default.find(function (c) {
    return c.code === countryCode;
  })) === null || _a === void 0 ? void 0 : _a.emoji;
}

exports.getCoutryEmoji = getCoutryEmoji;

function appendCountrySelectionToNode(node, config) {
  var countriesSelection = document.createElement("div");
...
exports.appendCountrySelectionToNode = appendCountrySelectionToNode;

function getChecked(node) {
  return Array.from(node.querySelectorAll(":checked")).map(function (x) {
    return x.value;
  });
}

exports.getChecked = getChecked;
},{"./countryFlags.json":"zSG3"}],"hADF":[function(require,module,exports) {
"use strict";
...
exports.tsv = tsv;
},{"d3-dsv":"mQVF","./text":"QFek"}],"oqjg":[function(require,module,exports) {
"use strict";
...
exports.svg = svg;
},{"./text":"QFek"}],"hNko":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./blob":"NEvU","./buffer":"W4GS","./dsv":"fvyQ","./image":"oqjg","./json":"LvcW","./text":"QFek","./xml":"FRc5"}],"yF4t":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./formatPrefixAuto.js":"KTGF","./formatRounded.js":"e8gU"}],"QWQX":[function(require,module,exports) {
"use strict";
...
},{"../pointEqual.js":"j4Ms"}],"Cmis":[function(require,module,exports) {
"use strict";
...
},{"../clip/rectangle.js":"E6SH","../identity.js":"nPOL","../transform.js":"ubFV","./fit.js":"Ty3O"}],"yWpl":[function(require,module,exports) {
"use strict";
...
var api_connection_1 = require("./covid/api-connection");

var covid_manipulation_1 = require("./covid/covid-manipulation");

var countries_1 = require("./country/countries");

var d3 = __importStar(require("d3"));

var initialRegions = ["MX", "RU", "CA", "EC", "BR", "KR", "TR", "CO", "ES", "IT"];

function main() {
  return __awaiter(this, void 0, void 0, function () {
    var chart, flag, c, countryForm;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4
          /*yield*/
          , covidCountryChart.init()];

        case 1:
          chart = _a.sent();
          flag = false;
          c = 0;
          countryForm = countries_1.appendCountrySelectionToNode(document.querySelector("div.container"), {
            initialValue: initialRegions
          });
          countryForm.addEventListener("change", function () {
            var regions = countries_1.getChecked(countryForm);
            console.log(regions);
            chart.render(Object.assign(__assign({}, chart.getCurrentValue()), {
              regions: regions
            }));
          });
          return [2
...
function activateControls() {
  ...
  function controlHasChange() {
    var nCases = Number(d3.select("#nCases").property("value"));
    var scale = d3.select('input[name="scale"]:checked').property("value");
    var statsToShow = d3.select("#stats").property("value");
    console.log({
      nCases: nCases,
      scale: scale,
...
var getData = function getData(_a) {
  var _b = _a === void 0 ? deafultValues : _a,
      regions = _b.regions,
      matchCases = _b.matchCases,
      metric = _b.metric;

  return __awaiter(void 0, void 0, void 0, function () {
    var regionResult, _c, data, i, _d, location, stats, matchedStartingPoint, copy, result;
      ...
      switch (_e.label) {
        case 0:
          ...
          , Promise.all(regions.map(function (r) {
            return api_connection_1.getCountryStats(r);
          })).catch(console.warn)];
        ...
        case 1:
          ...
          return [4
          /*yield*/
          , Promise.all(deafultValues.regions.map(function (r) {
            return api_connection_1.getCountryStats(r);
          }))];
        ...
        case 3:
          ...
          for (i = 0; i < regionResult.length; i++) {
            _d = regionResult[i], location = _d.location, stats = _d.stats;
            data[location.isoCode] = stats.history;
          }

          matchedStartingPoint = covid_manipulation_1.matchRegionsHist(data, matchCases, metric);
          copy = Object.keys(matchedStartingPoint);
          result = copy.map(function (id) {
            return {
              id: id,
...
var covidCountryChart = {
  init: function init() {
    return __awaiter(this, void 0, void 0, function () {
      function controlHasChange() {
        return __awaiter(this, void 0, void 0, function () {
          var scale, matchCases, metric;
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                scale = d3.select('input[name="scale"]:checked').property("value");
                matchCases = d3.select('input[name="cases"]:checked').property("value");
                metric = d3.select('input[name="stats"]:checked').property("value");
                return [4
                /*yield*/
                , render({
                  scale: scale,
      ...
      var svg, margin, width, height, scales, x, z, data, y, line, yAxis, currentValues, render;
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            Object.keys(scales).forEach(function (scaleType) {
              scales[scaleType].rangeRound([height - margin.bottom, margin.top]);
            });
            x = d3.scaleLinear().rangeRound([margin.left, width - margin.right]).domain([0, deafultValues.windowSizeIndays]);
            z = d3.scaleOrdinal(d3.schemeCategory10);
            svg.append("g").attr("class", "x-axis").attr("transform", "translate(0," + (height - margin.bottom) + ")").call(d3.axisBottom(x));
            svg.append("g").attr("class", "y-axis").attr("transform", "translate(" + margin.left + ",0)"); // X title

            svg.append("text").attr("transform", "translate(" + width / 2 + ", " + (height + margin.top + 10) + ")").style("text-anchor", "middle").text("Días desde 20 casos");
            return [4
            /*yield*/
            , getData()];
          ...
          case 1:
            data = _a.sent();
            y = scales[deafultValues.scale];
            line = d3.line().defined(function (d) {
              return !isNaN(d[deafultValues.metric]);
            }).curve(d3.curveLinear).x(function (d) {
              return x(d.index);
            }).y(function (d) {
              return y(d[deafultValues.metric]);
            });
            y.domain([deafultValues.matchCases || 1, d3.max(data, function (d) {
              return d3.max(d.values, function (c) {
                return Number(c[deafultValues.metric]);
              });
            })]).clamp(true);
            svg.selectAll(".x-axis").transition().duration(1000).call(d3.axisBottom(x));
            currentValues = __assign({}, deafultValues);

            render = function render(options) {
              if (options === void 0) {
                options = deafultValues;
              }

              return __awaiter(_this, void 0, void 0, function () {
                var scale, metric, matchCases, regions, data, line, t, regions, regionsEnter;
                return __generator(this, function (_a) {
                  switch (_a.label) {
                    case 0:
                      currentValues = Object.assign(__assign({}, currentValues), options);
                      scale = currentValues.scale, metric = currentValues.metric, matchCases = currentValues.matchCases, regions = currentValues.regions;
                      d3.select("h3").text("COVID-19 Casos " + (metric === "deaths" ? "letales" : "confirmados") + " en escala logar\xEDtmica desde los primeros " + matchCases + " casos");
                      return [4
                      /*yield*/
                      , getData({
                        regions: regions,
                    ...
                    case 1:
                      ...
                      y.domain([Number(matchCases) || 1, d3.max(data, function (d) {
                        return d3.max(d.values, function (c) {
                          return Number(c[metric]);
                        });
                      })]).clamp(true);
                      line = d3.line().defined(function (d) {
                        return !isNaN(d[metric]);
                      }).curve(d3.curveLinear).x(function (d) {
                        return x(d.index);
                      }).y(function (d) {
                        return y(d[metric]);
                      ...
                      svg.selectAll(".y-axis").transition(t).call(yAxis).call(function (g) {
                        return g.selectAll(".tick:not(:first-of-type) line").attr("stroke-opacity", 0.2).attr("stroke-dasharray", "2,2");
                      });
                      svg.selectAll(".x-axis").transition(t).call(d3.axisBottom(x));
                      regions = svg.selectAll(".region").data(data, function (d) {
                        return d.id;
                      });
                      regions.exit().remove();
                      regionsEnter = regions.enter().append("g").attr("class", "region"); // Line

                      regionsEnter.append("path").attr("class", "line").style("opacity", 0).merge(regions.select("path")).style("stroke", function (d) {
                        return z(d.id);
                      }).transition(t).style("opacity", 1).attr("d", function (d) {
                        return line(d.values);
                      }); // Circles

                      regionsEnter.append("g").attr("class", "circles").attr("fill", function (d) {
                        return z(d.id);
                      }).merge(regions.select("g")).selectAll("circle").data(function (d) {
                        return d.values;
                      }).join(function (enter) {
                        ...
                        return update.call(function (update) {
                          return update.transition(t).attr("cx", function (d) {
                            return x(d.index);
                          }).attr("cy", function (d) {
                            return y(d[metric]);
                          });
                        });
                      }).attr("r", 2); // Place labels

                      regionsEnter.insert("text").attr("class", "label").attr("x", function (d) {
                        return x(d.values.length - 1) + 5;
                      }) // Place the ticks at the same y position as
                      // the last y value of the line (remember, d is our array of points)
                      .attr("y", function (d) {
                        return y(d.values[d.values.length - 1] ? d.values[d.values.length - 1][metric] : false);
                      }).merge(regions.select("text")).attr("dy", "0.35em").style("fill", function (d) {
                        return z(d.id);
                      }).text(function (d) {
                        return countries_1.getCoutryEmoji(d.id) + " " + d.id;
                      }).transition(t) // place the ticks to the right of the chart
                      .attr("x", function (d) {
                        return x(d.values.length - 1) + 5;
                      }) // Place the ticks at the same y position as
                      // the last y value of the line (remember, d is our array of points)
...
main();
},{"./covid/api-connection":"mcie","./covid/covid-manipulation":"Zplo","./country/countries":"bQ0p","d3":"BG5c"}]},{},["QCba"], null)
//# sourceMappingURL=/pandemia-stats/pandemia-stats.b64d89c4.js.map